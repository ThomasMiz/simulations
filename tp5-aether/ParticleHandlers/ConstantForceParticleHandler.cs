...
public class ConstantForceParticleHandler : ParticleHandler
{
    ...
    public ConstantForceParticleHandler(float spawnRate, float force, float particleRadius, bool isLeftToRight)
    {
    ...
    protected override void OnPreUpdate(float deltaTime, double elapsed)
    {
        while (nextSpawnTime < elapsed)
        {
            ...
            AddParticle(new Vector2(spawnX, spawnY), new ConstantForceParticle(ParticleRadius, Force));
        }
    }
