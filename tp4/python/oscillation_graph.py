...
output_files = {
    "Verlet": "../bin/Debug/net8.0/output-simple-verlet-501steps-dt1e-002.txt",
    "Beeman": "../bin/Debug/net8.0/output-simple-beeman-501steps-dt1e-002.txt",
    "Gear5": "../bin/Debug/net8.0/output-simple-gear5-501steps-dt1e-002.txt"
}
