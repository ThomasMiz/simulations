...
namespace AetherPhysics.Collision.Shapes
{
    ...
    public class CircleShape : Shape
    {
        ...
        {
            Vector2 center = transform.p + ComplexF.Multiply(ref _position, ref transform.q);
        ...
        public override bool RayCast(out RayCastOutput output, ref RayCastInput input, ref Transform transform, int childIndex)
        {
            ...
            Vector2 position = transform.p + ComplexF.Multiply(ref _position, ref transform.q);
        ...
        {
            // OPT: Vector2 p = transform.p + Complex2.Multiply(ref _position, ref transform.q);
