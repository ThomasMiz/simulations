...
namespace AetherPhysics.Collision.Shapes
{
    ...
    public class PolygonShape : Shape
    {
        ...
        {
            Vector2 pLocal = ComplexF.Divide(point - transform.p, ref transform.q);
        ...
        public override bool RayCast(out RayCastOutput output, ref RayCastInput input, ref Transform transform, int childIndex)
        {
            ...
            if (index >= 0)
            {
                ...
                output.Normal = ComplexF.Multiply(Normals[index], ref transform.q);
                return true;
            }
        ...
        public override float ComputeSubmergedArea(ref Vector2 normal, float offset, ref Transform xf, out Vector2 sc)
        {
            ...
            Vector2 normalL = ComplexF.Divide(ref normal, ref xf.q);
