...
using AetherPhysics.Common.PhysicsLogic;
...
namespace AetherPhysics.Dynamics
{
    public partial class Body
    {
        ...
        {
            return ComplexF.Multiply(ref localVector, ref _xf.q);
        }
        ...
        {
            return ComplexF.Divide(ref worldVector, ref _xf.q);
        }
        ...
        internal void SynchronizeFixtures()
        {
            ...
            xf1.p = _sweep.C0 - ComplexF.Multiply(ref _sweep.LocalCenter, ref xf1.q);
        ...
        internal void SynchronizeTransform()
        {
            ...
            _xf.p = _sweep.C - ComplexF.Multiply(ref _sweep.LocalCenter, ref _xf.q);
        }
