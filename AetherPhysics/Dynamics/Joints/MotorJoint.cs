...
namespace AetherPhysics.Dynamics.Joints
{
    ...
    public class MotorJoint : Joint
    {
        ...
        internal override void InitVelocityConstraints(ref SolverData data)
        {
            ...
            _rA = -ComplexF.Multiply(ref _localCenterA, ref qA);
            _rB = -ComplexF.Multiply(ref _localCenterB, ref qB);
            ...
            _linearError = cB + _rB - cA - _rA - ComplexF.Multiply(ref _linearOffset, ref qA);
