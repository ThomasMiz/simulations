    ...
    public class GearJoint : Joint
    {
        ...
        public GearJoint(Body bodyA, Body bodyB, Joint jointA, Joint jointB, float ratio = 1f)
        {
            ...
            else
            {
                ...
                Vector2 pA = ComplexF.Divide(ComplexF.Multiply(ref _localAnchorA, ref xfA.q) + (xfA.p - xfC.p), ref xfC.q);
            ...
            else
            {
                ...
                Vector2 pB = ComplexF.Divide(ComplexF.Multiply(ref _localAnchorB, ref xfB.q) + (xfB.p - xfD.p), ref xfD.q);
        ...
        internal override void InitVelocityConstraints(ref SolverData data)
        {
            ...
            ComplexF qC = ComplexF.FromAngle(aC);
            ComplexF qD = ComplexF.FromAngle(aD);
            ...
            {
                Vector2 u = ComplexF.Multiply(ref _localAxisC, ref qC);
                Vector2 rC = ComplexF.Multiply(_localAnchorC - _lcC, ref qC);
                Vector2 rA = ComplexF.Multiply(_localAnchorA - _lcA, ref qA);
                _JvAC = u;
            ...
            {
                Vector2 u = ComplexF.Multiply(ref _localAxisD, ref qD);
                Vector2 rD = ComplexF.Multiply(_localAnchorD - _lcD, ref qD);
                Vector2 rB = ComplexF.Multiply(_localAnchorB - _lcB, ref qB);
                _JvBD = _ratio * u;
        ...
        internal override bool SolvePositionConstraints(ref SolverData data)
        {
            ...
            else
            {
                ...
                Vector2 pA = ComplexF.Divide(rA + (cA - cC), ref qC);
                coordinateA = Vector2.Dot(pA - pC, _localAxisC);
            }
            ...
            else
            {
                ...
                Vector2 pB = ComplexF.Divide(rB + (cB - cD), ref qD);
                coordinateB = Vector2.Dot(pB - pD, _localAxisD);
            }
