...
namespace AetherPhysics.Common
{
    ...
    {
        private static readonly Transform _identity = new Transform(Vector2.Zero, ComplexF.One);
        ...
        /// <summary>
        /// Initialize using a position vector and a Complex2 rotation.
        /// </summary>
        /// <param name="position">The position.</param>
        /// <param name="rotation">The rotation</param>
        public Transform(Vector2 position, ComplexF rotation)
        {
            q = rotation;
            p = position;
        }
        ...
        public Transform(Vector2 position, float angle)
            : this(position, ComplexF.FromAngle(angle))
        {
        }
        ...
        {
            // Opt: var result = Complex2.Multiply(left, right.q) + right.p;
            return new Vector2(
        ...
        {
            // Opt: var result = Complex2.Divide(left - right.p, right);
        ...
        public static Transform Multiply(ref Transform left, ref Transform right)
        {
            return new Transform(
                    ComplexF.Multiply(ref left.p, ref right.q) + right.p,
                    ComplexF.Multiply(ref left.q, ref right.q));
        }

        public static Transform Divide(ref Transform left, ref Transform right)
        {
            return new Transform(
                ComplexF.Divide(left.p - right.p, ref right.q),
                ComplexF.Divide(ref left.q, ref right.q));
        }
        
        public static void Divide(ref Transform left, ref Transform right, out Transform result)
        {
            ComplexF.Divide(left.p - right.p, ref right.q, out result.p);
            ComplexF.Divide(ref left.q, ref right.q, out result.q);
        }
            
        public static void Multiply(ref Transform left, ComplexF right, out Transform result)
        {
            result.p = ComplexF.Multiply(ref left.p, ref right);
            result.q = ComplexF.Multiply(ref left.q, ref right);
        }
        
        public static void Divide(ref Transform left, ComplexF right, out Transform result)
        {
            result.p = ComplexF.Divide(ref left.p, ref right);
            result.q = ComplexF.Divide(ref left.q, ref right);
        }
    }
    ...
    public struct Sweep
    {
        ...
        public void GetTransform(out Transform xfb, float beta)
        {
            ...
            xfb.q = ComplexF.FromAngle(angle);

            // Shift to origin
            xfb.p -= ComplexF.Multiply(ref LocalCenter, ref xfb.q);
        }
